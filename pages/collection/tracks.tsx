        ...
        <>
          <div className="flex items-end gap-6">
            ...
            <div className="flex flex-col gap-3">
              <h5 className="text-sm font-bold uppercase text-btnText">
                Playlist
              </h5>
              <h2 className="text-5xl font-bold text-btnText">Liked Songs</h2>
              <div className="flex items-center gap-5 text-sm">
                <span className="font-bold text-btnText">
                  {session?.user?.name}
                </span>
                {likedTracks.items.length > 0 && (
                  <span className="text-btnText">
                    {likedTracks.total} songs
                  </span>
                )}{" "}
              </div>
            </div>
