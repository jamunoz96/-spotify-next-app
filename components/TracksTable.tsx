      ...
      <div className="w-full col-span-12">
        {tracks?.map((track, index) => (
          <div className={`grid grid-cols-12`} key={track.id + index + 1}>
            <div className="flex items-center col-span-1 my-3 text-sm text-btnText">
              {index + 1}
            </div>
            ...
            >
              <div className="flex items-center w-full gap-4">
                ...
                <div className="w-full">
                  <h2 className="w-10/12 text-sm font-medium truncate cursor-default text-btnText">
                    {track.name}
                  </h2>

                  {!noArtist && (
                    <div className="flex flex-wrap items-center w-10/12 gap-1 text-sm text-btnText">
